...
class leih_bill_release_wizard(osv.osv_memory):
    _name = 'leih.bill.release.wizard'
    _description = 'Wizard to confirm release of selected bill'
    ...
    def action_confirm_release(self, cr, uid, ids, context=None):
        ...
        # perform the release on leih.admission
        self.pool.get('bill.register').write(cr, uid, active_ids, {'state': 'released'}, context=context)

        # close the wizard
        return {'type': 'ir.actions.act_window_close'}

leih_bill_release_wizard()
