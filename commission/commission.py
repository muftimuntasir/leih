...
class commission(osv.osv):
    ...
    def customer_on_select(self):
        ...
        if self.ref_doctors:
            ...
            doctor_ids = [items.get('id') for items in doctors_ids]
    ...
    def commission_line_ids_code(self):
        ...
        for line_item in self.commission_line_ids:
            ...
            total_discount=total_discount+line_item.discount_amount
        self.total_amount = total_sum
        self.given_discount_amount=total_discount
        return 'ss'
